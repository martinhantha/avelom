...
5. **Reverse Proxy / TLS**: Coolify vergibt automatisch Zertifikate; öffentliche Domain für die **Web-/API-App** ist **`app.alpiplan.com`** (`web`, Port 3000 im Compose-Beispiel).
